...
python train.py -bs 16 -rn res34d_upConv_AlbuV1 -enc resnet34d -lr 1e-4 -lrsp 10 -lrsf 0.5;
python train.py -bs 16 -rn res34d_upConv_AlbuV1 -enc resnet34d -lr 1e-4 -lrsp 10 -lrsf 0.1;
