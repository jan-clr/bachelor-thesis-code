...
python train.py -bs 16 -rn res34d_upConv_AlbuV2 -enc resnet34d -lr 1e-4 -lrsp 10 -lrsf 0.5;
python train.py -bs 32 -rn res34d_upConv_AlbuV2 -enc resnet34d -lr 1e-4 -lrsp 10 -lrsf 0.5;
